...
const CartPage: React.FC = () => {
  const [products, setProducts] = useState<Product[]>([
    { id: 1, name: 'Nombre Producto 1', price: 19.99, color: 'purple', quantity: 2, image: '/images/backround/morado.png', colorSets: [{name:"bb", id:"12", colors:['#FFDA03', '#A52A2A', '#228B22']}], formats: []},
    { id: 2, name: 'Nombre Producto 2', price: 29.99, color: 'blue', quantity: 3, image: '/images/backround/azul.png', colorSets: [{name:"bb", id:"12", colors:['#A52A2A','#FFDA07',  '#228B22']}], formats: []},
  ]);
    ...
    <div className="flex flex-col min-h-[100vh] justify-between">
      ...
      <main className="flex flex-1 items-center justify-center">
        <div className="container mx-auto p-6">
          <h1 className="text-4xl font-bold text-center mb-6">CARRITO DE COMPRAS</h1>
